...
exports.forgotPassword = async (req, res) => {
  try {
    //* 1) Da go pronajdeme korisnikott so pomos na negoviot email
    ...
    //* 3) Da go zapiseme resetirackiot token vo korisnickiot dokument vo baza
    ...
    //* Zapisuvame minutaza koja korisnikot ke ja ima za da go promeni korisnickiot password (30 minuti)
    user.passwordResetExpires = Date.now() + 30 * 60 * 1000;
    await user.save({ validateBeforeSave: false });

    //* 4) Da ispratime link do korisnickiot e-mail
...
exports.resetPassword = async (req, res) => {
  try {
    ...
    //* 2) Barame vo kolekcijata korisnici, dali postoi korisnik sto go ima ovoj token
    ...
    //* 3) I sega ke proverime vo slucaj da ne pronajde korinsik
